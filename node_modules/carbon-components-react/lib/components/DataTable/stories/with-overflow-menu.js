...
var _default = function _default(props) {
  return _react.default.createElement(_DataTable.default, _extends({
    ...
    render: function render(_ref) {
      ...
      return _react.default.createElement(_DataTable.TableContainer, {
      ...
      }, _react.default.createElement(_DataTable.Table, getTableProps(), _react.default.createElement(_DataTable.TableHead, null, _react.default.createElement(_DataTable.TableRow, null, _react.default.createElement(_DataTable.TableSelectAll, getSelectionProps()), headers.map(function (header) {
        return _react.default.createElement(_DataTable.TableHeader, getHeaderProps({
          header: header
        }), header.header);
      }), _react.default.createElement(_DataTable.TableHeader, null))), _react.default.createElement(_DataTable.TableBody, null, rows.map(function (row) {
        ...
        }), _react.default.createElement(_DataTable.TableCell, null, _react.default.createElement(_OverflowMenu.default, {
          flipped: true
        }, _react.default.createElement(_OverflowMenuItem.default, {
          primaryFocus: true
        }, "Action 1"), _react.default.createElement(_OverflowMenuItem.default, null, "Action 2"), _react.default.createElement(_OverflowMenuItem.default, null, "Action 3"))));
      }))));
    }
  }));
};
