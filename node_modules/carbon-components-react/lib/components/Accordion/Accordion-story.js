...
_Select.default.displayName = 'Select';
(0, _react2.storiesOf)('Accordion', module).addDecorator(_addonKnobs.withKnobs).add('Default', function () {
  return _react.default.createElement(_Accordion.default, null, _react.default.createElement(_Accordion.AccordionItem, _extends({
