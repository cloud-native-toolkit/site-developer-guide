  ...
  var _ref10 = (0, _asyncToGenerator2.default)(function* (starter, options = {}) {
    ...
    if (urlObject.protocol && urlObject.host) {
      ...
      if (/gatsby-starter/gi.test(rootPath) && isStarterAUrl) {
        report.panic(`It looks like you gave wrong argument orders . Try running instead "gatsby new ${starter} ${rootPath}"`);
        return;
      }

      report.panic(`It looks like you passed a URL to your project name. Try running instead "gatsby new new-gatsby-project ${rootPath}"`);
      return;
    }
