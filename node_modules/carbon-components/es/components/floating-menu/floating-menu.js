    ...
    value: function _changeState(state, detail, callback) {
      ...
      if (state === 'shown') {
        ...
        if (!this.element.hasAttribute(this.options.attribAvoidFocusOnOpen)) {
          ...
          var focusableNode = this.element.querySelector(settings.selectorTabbable);
          ...
          if (primaryFocusNode) {
            ...
            if (process.env.NODE_ENV !== "production") {
              ...
              process.env.NODE_ENV !== "production" ? warning(elementTabindex !== null && parseInt(elementTabindex, 10) > -1, 'Floating Menus without interactive elements must include tabindex="0" on the floating element.') : void 0;
            }
          }
        }
      }
