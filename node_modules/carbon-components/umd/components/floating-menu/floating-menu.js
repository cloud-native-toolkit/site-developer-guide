...
})(this, function (_exports, _warning, _mixin2, _settings, _createComponent, _eventedShowHideState, _handles, _trackBlur, _getLaunchingDetails, _resize, _on) {
  "use strict";
      ...
      value: function _changeState(state, detail, callback) {
        ...
        if (state === 'shown') {
          ...
          if (!this.element.hasAttribute(this.options.attribAvoidFocusOnOpen)) {
            ...
            var focusableNode = this.element.querySelector(_settings.default.selectorTabbable);
            ...
            if (primaryFocusNode) {
              ...
              if (process.env.NODE_ENV !== "production") {
                ...
                process.env.NODE_ENV !== "production" ? (0, _warning.default)(elementTabindex !== null && parseInt(elementTabindex, 10) > -1, 'Floating Menus without interactive elements must include tabindex="0" on the floating element.') : void 0;
              }
            }
          }
        }
