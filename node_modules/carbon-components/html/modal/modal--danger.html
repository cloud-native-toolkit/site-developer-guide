...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-n1y7ghg0wu">Show
  modal</button>

<div data-modal id="modal-n1y7ghg0wu" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-n1y7ghg0wu-label" aria-describedby="modal-n1y7ghg0wu-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-n1y7ghg0wu-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-n1y7ghg0wu-heading">Modal heading</p>
