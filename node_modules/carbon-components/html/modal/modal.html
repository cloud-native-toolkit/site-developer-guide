...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-hqqszdkyi8">Show
  modal</button>

<div data-modal id="modal-hqqszdkyi8" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-hqqszdkyi8-label" aria-describedby="modal-hqqszdkyi8-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-hqqszdkyi8-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-hqqszdkyi8-heading">Modal heading</p>
