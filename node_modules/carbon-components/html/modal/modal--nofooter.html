...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-n1syq0kv50s">Show
  modal</button>

<div data-modal id="modal-n1syq0kv50s" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-n1syq0kv50s-label" aria-describedby="modal-n1syq0kv50s-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-n1syq0kv50s-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-n1syq0kv50s-heading">Modal heading</p>
