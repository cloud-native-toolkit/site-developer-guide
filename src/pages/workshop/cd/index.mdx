...
1. Set `TOOLKIT_USERNAME` environment variable. 
   ...
   If you configured your own workshop environment you can use the `userdemo` value.
    ```bash
...
1. Set `TOOLKIT_PROJECT` environment variable. 
   If you are participation in a workshop replace `projectdemo` with your assigned project (ex. `project01`).
   If you configured your own workshop environment you can use the `projectdemo` value.
    ```bash
