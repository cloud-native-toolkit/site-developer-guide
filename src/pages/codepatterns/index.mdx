...
![Code Pattern Architect](src/pages/codepatterns/architecture.pngtterns/architecture.png)
...
![Initial JFrog](src/pages/codepatterns/cloudnative.pngatterns/cloudnative.png)
