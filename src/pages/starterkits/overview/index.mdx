...
a set of **Starter Kit Templates**. These have been designed to give a production ready
entry point for cloud native development. While use of the **Starter Kit Templates** is not required to be able
to use the development tools, their use is **highly recommended**.

There are a small number of templates that provide support for different architecture layers of your Kubernetes
...
These patterns can be "enabled" using the `Bring your own code` approach on [Starter Kit templates](../../starterkits/starterkittemplates).
...
The objective of the *Starter Kit Templates* is to kick off a project quickly so they can reach maximum development
...
The purpose of the Starter Kit Template is to provide the scaffold code for the elements outside of your working
