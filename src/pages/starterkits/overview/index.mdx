...
a set of **Starter Kit Templates**. These have been designed to give you a production ready
entry point for cloud native development. There are a small number of templates
...
You can work with [Code Patterns](https://developer.ibm.com/patterns/) from  [developer.ibm.com](https://developer.ibm.com/).
You will need to upgrade the `Dockerfile` to be UBI compliant and add a `Jenkinsfile` or `Tekton pipeline`. These patterns are
not optimised for production usage and do not include a number of key IBM Garage best practices. They are fully open source and they
can be enhanced overtime.

There is more information below on what is included in the **Starter Kit Templates**.
...
The Starter Kits provide a key number of these supporting files and meta data and are tested on every code change to make sure they work with IBM Kubernetes and IBM Red Hat OpenShift managed clusters.
...
The purpose of the Sstarter Kit Template is to provide the scaffold code for the elements outside of your working
...
If you want to contribute a **Starter Kit Template** have a look at the examples that are provided. They all have most of the
