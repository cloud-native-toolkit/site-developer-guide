...
This article explains the concepts described in the video. You can access the presentation in the [Office Hours](https://ibm.box.com/v/Office-Hours) folder in Box. The scripts discussed are [available in GitHub](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/tree/master/terraform/scripts).
...
- [Best practices for assigning access](https://cloud.ibm.com/docs/account?topic=account-account_setup)
...
[Best practices for assigning access](https://cloud.ibm.com/docs/account?topic=account-account_setup) has similar tips and some additional explanation.
