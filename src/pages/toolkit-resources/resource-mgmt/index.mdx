...
- **Two development environments**: Each development environment has a corresponding resource group, in this example named `app1` and `app2`. The first has a Kubernetes cluster while the second has an OpenShift cluster.
