...
The most fundamental component type is a resource. To organize an account that will be shared by numerous users, two key aspects are:
- Creating a good set of resource groups to organize the resources
- Creating a good set of access groups to organize access to the resources
