...
- Follow the directions in [Deploying an App](/getting-started/deploy-app)
    ...
    - Be sure to run the Jenkins pipeline for your project, and confirm that it runs the Sonar scan stage
...
- Go to the Projects page
    ...
    The project summary shows the number of issues found in the app, catagorized by type
...
- Click on the "1" above Security hotspots
    ...
    As the rule explains, "Command line arguments can be dangerous just like any other user input. They should never be used without being first validated and sanitized." This method passes them through unchecked.
