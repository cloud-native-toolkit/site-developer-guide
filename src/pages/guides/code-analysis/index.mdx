...
Simply by building your app using the Jenkins pipeline, your code gets analyzed, just open the SonarQube UI to browse the findings.
...
After running the pipeline, open the SonarQube UI and browse the findings in your app's project.