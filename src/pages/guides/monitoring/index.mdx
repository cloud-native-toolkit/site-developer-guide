...
- Before you start to understanding how to monitor your application instances, make sure you have [deployed an app](/getting-started/deployapp) into your development cluster. this _Git it a Try_ will use the [template-node-typescript](/starterkits/starterkittemplates) as an example.
