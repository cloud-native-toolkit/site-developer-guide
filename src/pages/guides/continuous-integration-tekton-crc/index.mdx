---
title: Continuous Integration with Tekton on CRC
...
<iframe width="80%" height="500" src="https://www.youtube.com/embed/2TWocBgwt8k" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
- Install [Red Hard Code Ready Containers](/admin/https://cloud.ibm.com/catalog/content/ibm-cp-applications
...
- Start you Red Hat CRC
    ```
    crc start
    ```
- Install the Tekton Operator into your CRC environment
...
- Using the **Starter Kit Template** of your choice install the _Pipeline_ into your `dev` namespace. For example use the [**Template Node TypeScript**](https://github.com/ibm-garage-cloud/template-node-typescript.git)
    ...
    crc apply -f tekton -n dev
    ```
- Here are the `tkn` commands for kicking off a `PipelineRun`
    ```
    tkn
    ```
