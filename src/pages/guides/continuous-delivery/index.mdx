...
In IBM Garage Method, one of the Develop practices is [continuous delivery](https://www.ibm.com/garage/method/practices/deliver/practice_continuous_delivery/). The Developer Tools environment uses an [Argo CD](https://argoproj.github.io/argo-cd/) pipeline to automate continuous delivery.
