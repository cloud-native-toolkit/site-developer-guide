...
<AnchorLinks small>
  <AnchorLink to="../../guides/artifactory">Artifact Management with Artifactory</AnchorLink>
  <AnchorLink to="../../guides/argocd">Continuous Delivery with ArgoCD</AnchorLink>
</AnchorLinks>
