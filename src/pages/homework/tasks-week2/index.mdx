...
| Review your image registry | Using the Image Registry guide, follow the _Give it a try_ section |[Image Registry](/tools/image-registry#give-it-a-try) | 15 mins |
| Review your app's code quality | Using the SonarQube guide, follow the _Give it a try_ section |[Code Analysis](/tools/code-analysis#give-it-a-try) | 30 mins |
| View your app's logs | Using the LogDNA guide, follow the _Give it a try_ section | [Log Management](/tools/log-management#give-it-a-try) | 20 min |
| Monitor your app | Using the SysDig guide, follow the _Give it a try_ section | [Monitoring](/tools/monitoring#give-it-a-try) | 30 min |
