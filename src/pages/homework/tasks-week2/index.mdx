...
Once you have completed these tasks you will have experienced both the **Day 1** Experience of creating your first app and CI pipeline. You will have then extended that into a 3 tier polyglot solution. You will have then completed the **Day 2 Experience* of working with you solution logs, monitoring you app and then understanding how to move you code from `dev` to `test`.

What is very clear is that with Red Hat OpenShift and IBM Kubernetes managed services combinded with the powerful cloud services and with IBM Garage for Cloud Developer tools you have a powerful development platform to enable you to build any form of cloud native solution. Watch out for the **IBM Cloud Pak Developers Guide** coming in 2020.
