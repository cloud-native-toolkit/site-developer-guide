...
Session 4 of the MOOC focuses on Cloud Pak for Integration, **CP4I** has
 been installed with single sign on in the IBM Cloud in the same way a client
...
| Integration Modernization |  Agile Integration Architecture | [Agile Architecture](https://www.ibm.com/downloads/cas/J7E0VLDY) | 1 Hour |
...
| Review "The Asset Repository  | Review the IBM Garage and Solution Engineering teams Asset repository | [Asset Repository](https://ibm-cloud-architecture.github.io/deliverables/integration.html) | 4 hours |
| Labs 1 | Enable order processing flow using Event Streams, App Connect, MQ , API Connect and Asset Repository | [Lab 1](https://github.ibm.com/rsundara/cp4i-labs/tree/master/lab1) | 2 Hours |
...
Once you have completed these tasks, you will have completed the homework for
 Session 3. You will now have an understanding of the IBM Cloud Garage
