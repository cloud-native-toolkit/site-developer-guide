...
This homework assumes that you have:
 - Reviewed the [playback]() from the Monday session
 - Seen demos and discussion about what is expected from the homework
 - Seen a demo of each of the homework tasks below

<InlineNotification>

**Note**: Support is provided in the `#catalyst-project` Slack channel (in the [IBM Garage for Cloud](http://ibm-garage.slack.com) team).
...
| Install Prerequisite tools | [Install Prerequisites](/installation/pre-reqs) | 1 hr |
...
| **Bonus Credit** Complete Part 1 using IBM Kubernetes Development Cluster in your team `resource group` | [Part 1 Exercise](/practical/inventory) | 1 hr |
