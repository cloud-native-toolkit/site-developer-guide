...
The homework for the Week 1 is to learn how to approach cloud development with IBM Red Hat OpenShift. You need to have reviewed the [playback]() from the Monday session. You will have seen demos and discussion about what is expected from the homework. You will have seen a demo of each of the tasks below.
...
**Week 1** is focused on Day 1 development, the common tasks to getting started as soon as a project inception has completed and enable the developers to achieve velocity as quickly as possible.
...
The homework review will take the form of a retrospective with the attendees that have completed the tasks during the week. We are looking for three key comments:

- **What went well?**
- **What needs improvement?**
- **Next Steps ?**

We are expecting a wide variety of skill levels working through this material so the next steps will factor in the expected areas of clarify and skills improvements that maybe required. The key objective is to prepare developers and architects with the skills to perform a Garage engagement as confidently as they can.
