...
| Task                | Link        | Time |
| -----------------   |:----------- |------|
| Install Prerequisite tools | [Install Prerequisites](/getting-started/prereqs) | 1 hr |
...
| Start Part 1 of the **Inventory Micro App** | [Part 1 Exercise](/practical/inventory-part1) | 1-2 hr |
| **Bonus Credit** Complete Part 1 using IBM Kubernetes Development Cluster in your teams `resource group` | [Part 1 Exercise](/practical/inventory-part1w) | 1 hr |
...
The homework for Week 2 is focused on how a development team would operating and manage their applications. This will include monitoring, logging, security and
...
**Week 2** is focused on Day 1 development. Day 1 occurs as soon as a project's inception has completed and is the first day of developing the MVP. These Day 1 tasks enable developers to achieve velocity as quickly as possible.
