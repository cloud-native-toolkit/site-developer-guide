...
- The education agenda and playbacks: [**Garage OpenShift and Cloud Pak MOOC**](https://www.onlinedigitallearning.com/course/view.php?id=5631)
...
The Welcome email gives you details on how to access the Developer Tools environment for your development team. The email will specify the MOOC Sandbox Registration Details:
...
- **Team name**: This is the name of your development team
...
- The Welcome email with the MOOC Sandbox Registration Details will tell you your account, team, Git organization, and resource group
...
- Under Cluster, you should see two clusters named `mooc-{team}-rhos-cluster` and `mooc-{team}-iks-cluster` (where `{team}` is the name of your team)
...
- "[My app runs on my computer](https://donthitsave.com/comic/2016/07/15/it-works-on-my-computer)" is necessary but not sufficient, it needs to run in the Developer Tools environment as well
