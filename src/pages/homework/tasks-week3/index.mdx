---
title: MOOC Homework Session 1, Week 3 (CP4Apps)
---

<PageDescription>

Homework for students in the MOOC Week 3 New Apps with Cloud Pak for Applications

</PageDescription>

This is the homework tasks for the [Garage OpenShift and Cloud Pak MOOC](/homework/teams).

## Week 3 -- New Apps - IBM Cloud Pak for Applications
...
Week 3 of the MOOC focuses on create new Cloud Native Application leveraging Cloud Pak for Applications.
...
| Dev Tools | Setup Dev Tools |[Setup Tools](/practical/cp4apps#new-apps-with-appsody-cli) | 15 mins |
| New Apps - CLI | Learn how to use Appsody CLI |[Appsody](/practical/cp4apps#new-apps-with-appsody-cli) | 15 mins |
| New Apps - IDE | Learn how to use CodeWind |[CodeWind](/practical/cp4apps#new-apps-with-codewind) | 15 mins |
| Build Apps | Learn how to use Tekton Pipelines | [Tekton Pipelines](/practical/cp4apps#build-apps-with-tekton-pipelines) | 15 mins |
