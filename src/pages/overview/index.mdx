...
Typically a [squad leader](https://www.ibm.com/garage/method/practices/culture/practice-building-effective-squads/) 
or lead developer installs and sets up a new Developer Tools environment after the 
[initial inception workshop](https://www.ibm.com/garage/method/practices/think/inception),
...
The installation is peformed using [Terraform](https://cloud.ibm.com/docs/terraform), 
with modular configuration so unneeded tools can be easily disabled or new tools added. 
