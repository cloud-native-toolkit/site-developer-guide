...
### Reduce risk through consistent delivery models from start to production
...
### Quickly ramp up development teams on <Globals name="kube" /> and <Globals name="ocp" />

Containerized platforms like <Globals name="kube" /> and <Globals name="ocp" /> provide a great deal of functionality and 
...
- A <Globals name="iks" /> or <Globals name="ocp" /> development cluster
