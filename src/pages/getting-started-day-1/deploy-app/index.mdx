...
![Pods on OpenShift](src/pages/getting-started-day-1/deploy-app/images/topology.png)
...
pattern templates and explore the environment to get familiar. For more information about the
