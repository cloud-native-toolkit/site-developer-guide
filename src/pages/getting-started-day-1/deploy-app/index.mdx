...
1. Open the OpenShift Web Console from the Developer Cluster instance
    ...
    ![OpenShift](src/pages/getting-started-day-1/deploy-app/images/openshiftconsole.png)
...
![OpenShift](src/pages/getting-started-day-1/deploy-app/images/ospipeline.png)
...
![Jenkins Pipeline](src/pages/getting-started-day-1/deploy-app/images/pipeline.png)
...
![OpenShift](src/pages/getting-started-day-1/deploy-app/images/tektonpipeline.png)
