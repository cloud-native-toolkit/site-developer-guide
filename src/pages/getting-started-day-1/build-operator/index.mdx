...
3. Create the README.md and the initial commit
...
5. Create an API for the operator
...
6. Commit the changes to the local git repository
...
7. Create a new git repository on GitHub and copy the url
   
8. Push the local git repository to the remote GitHub repository
...
1. Open the [operator catalog template repository](https://github.com/ibm-garage-cloud/template-operator-catalog) and 
