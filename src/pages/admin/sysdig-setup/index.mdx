...
Sysdig is the [<Globals name="env" />'s monitoring tool](/tools/sysdig). Before you can use it as part of the environment, you must finish setting up the new instance.
