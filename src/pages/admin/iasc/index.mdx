...
`Infrastruture as Code` is the practice of defining and managing the logic used to provision infrastructure as versioned
...
The Iteration Zero terraform scripts make use of the modules to provision and prepare an environment. A listing of
the files within the repository is shown below.
