...
- You must set `resource_group_name` and `vlan_region`, using the values provided by the account administrator
...
You must set all of these specifically for your cluster. Use the values provided by the account administrator.
