...
Fourth, the account administrator must create an access group to enable developers to access the Developer Tools environment. This can be done later, after the environment is created.
...
An environment administrator will run the scripts to create the Developer Tools environment in the data center. The scripts will run as the environment administrator's user, so the user needs these permissions:
