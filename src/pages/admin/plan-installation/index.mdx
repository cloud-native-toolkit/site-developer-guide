...
First, before installing an environment, the account administrator needs to [configure the IBM Cloud account](/admin/prepare-account) for the environment:
...
Third, after you install the environment, before giving the developers access to the environment, the environment administrator need to [finish configuring it](/admin/post-install):
