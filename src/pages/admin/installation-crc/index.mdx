---
title: Install into Red Hat CodeReady
---
...
**Warning:** Red Hat Containers (CRC) is based on OpenShift 4.2 and the current installation only supports the Tekton Pipeline Operator , Jenkins is not installed.
Read the [Tekton Pipelines and Tasks Guide](/guides/continuous-integration-tekton) to understand how to deploy your into CRC.
...
- Install the [Prerequisites](/admin/pre-reqs) listed before continuing
