...
**Warning:** Red Hat CodeReady Containers (CRC) is based on OpenShift 4.2 and the current installation only supports the Tekton pipeline operator, and Jenkins is not installed.
