...
- Download the current release of `create-catalog-offering.sh` from the <a href="https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases" target="_blank">latest releases link</a>
