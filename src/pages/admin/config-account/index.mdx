...
- Run the script `./terraform/scripts/acp-admin.sh`, which will add the necessary policies to the access group
...
- Run the script `./terraform/scripts/acp-user.sh`, which will add the necessary policies to the access group
