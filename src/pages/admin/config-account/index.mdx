...
Managing VLANs:
- [List existing VLANs](https://cloud.ibm.com/classic/network/vlans)
- [Catalog > Services > Networking > VLAN](https://cloud.ibm.com/catalog/infrastructure/vlan) -- Create a VLAN
