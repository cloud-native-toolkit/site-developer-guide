...
You can also tailor the list of content that is displayed in the Activitation tab and the Code Patterns tab by creating your own version of the [`links.json`](https://github.com/ibm-garage-cloud/developer-dashboard/blob/master/public/data/links.json) JSON file and host that somewhere accessible to you cluster's network.
