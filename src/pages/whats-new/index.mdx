...
[v1.11.1](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.11.1),
[v1.11.0](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.11.0),
[v1.10.2](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.10.2),
[v1.10.1](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.10.1),
[v1.10.0](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.10.0),
[v1.9.0](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.9.0),
[v1.8.1](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.8.1),
[v1.8.0](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.8.0),
[v1.7.1](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.7.1),
[v1.7.0](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.7.0),
[v1.6.0](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.6.0),
[v1.5.0](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.5.0)
...
[v2.5.0](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.5.0)
...
[v1.4.2](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.4.2),
[v1.4.1](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.4.1)
...
[v1.4.0](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.4.0),
[v1.3.0](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.3.0),
[v1.2.2](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.2.2),
[v1.2.1](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.2.2)
...
[v2.4.0](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.4.0)
...
[v2.3.9](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.3.9),
[v2.3.8](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.3.9),
[v2.3.7](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.3.9),
[v2.3.6](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.3.9),
[v2.3.5](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.3.9),
[v2.3.4](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.3.9),
[v2.3.3](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.3.9),
[v2.3.2](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.3.9),
[v2.3.1](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.3.9),
[v2.3.0](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.3.9),
[v2.2.2](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.3.9)
...
[v1.2.0](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.2.0),
[v1.1.0](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.1.0)
...
[v2.2.1](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.2.1),
[v2.2.0](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.2.0)
...
[v1.0.3](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.0.3),
[v1.0.2](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.0.2)
...
[v2.1.0](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.1.0),
[v2.0.2](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.0.2),
[v2.0.1](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.0.1)
...
[v2.0.0](https://github.com/cloud-native-toolkit/ibm-garage-iteration-zero/releases/tag/v2.0.0)

- Updates Tekton module and resources to support the Red Hat Tekton operator and related versions
- Simplifies the process to install the <Globals name="longName" /> on a <Globals name="ocp" /> provisioned anywhere
...
[v1.0.1](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli/releases/tag/1.0.1)
