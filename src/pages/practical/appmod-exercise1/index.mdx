...
**Note:** The DB2 database used by this application is at `169.62.108.167` on port `30866`
...
- Login to the traditional WebSphere Administrative Console
    ...
    NOTE: Chrome & Safari blocks https://localhost and doesn't allow exceptions recently.  You may need to install firefox to login to the console. Firefox blocks, but gives you the option to proceed anyways.
