...
1. Create a class named `Application` in the `com.ibm.inventory_management.app` package. 

1. Add the `@SpringBootApplication` and `@ComponentScan` annotation to the class. The `@ComponentScan`
...
1. Delete `com.ibm.hello.app.Application`
