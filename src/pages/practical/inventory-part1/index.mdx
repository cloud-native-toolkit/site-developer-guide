...
1. Create a new repository from the React UI Patterns Starter Kit template - https://github.com/ibm-garage-cloud/template-node-react/generate

2. Clone the new repository to your machine

3. Log into the cluster from the command-line then register the pipeline in Jenkins using `igc pipeline`
