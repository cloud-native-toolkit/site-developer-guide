...
These instructions explain how to configure and run the Terraform Infrastructure as Code to create the Developer Tools environment.
...
The first step is to create a **Resource Group**. The Developer Tools environment consists of several IBM Cloud resources--a Kubernetes or OpenShift cluster,
...
You must set all of these specifically for your cluster.
