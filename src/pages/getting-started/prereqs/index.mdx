...
- [OpenShift OC CLI](https://www.okd.io/download.html): Required for Red Hat OpenShift management and development
    ...
    ```
    - *P.S. Depending on your MacOS security settings you may need to allow access to `oc` and `kubectl`, go to `System Preferences`=>`Security & Privacy` and press `Allow Anyway`*
