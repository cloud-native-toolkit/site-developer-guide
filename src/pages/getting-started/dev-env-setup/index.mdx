...
[Docker Desktop](https://www.docker.com/products/docker-desktop) is required for working with container images locally, running common tools and using the [Developer Tools Image](https://ibm-garage-cloud.github.io/ibm-garage-developer-guide/guides/tools-image).
