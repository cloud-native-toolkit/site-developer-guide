...
- Enable existing Starter Kits with the necessary artifacts to be integrated
 easily into the Developer Tools environment
...
This enables new pipelines to be registered and run and for them to have
 access to all the essential data needed to access the tools and the IBM
  Cloud platform.
