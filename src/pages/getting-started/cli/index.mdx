...
The [<Globals name="igccli" />](https://github.com/cloud-native-toolkit/ibm-garage-cloud-cli) provides a set of helpful
...
- Register your application's git repo into a CI pipeline ([Jenkins](/tools/jenkins), [Tekton](/tools/tekton/), etc.)
...
- Populate the tiles on the [Developer Dashboard](/getting-started-day-1/dashboard/)
...
2. Download the `index.yaml` file containing the available pipeline versions
    ...
    ```shell script
    curl -O https://cloud-native-toolkit.github.io/garage-pipelines/index.yaml
    ```
