...
**Warning**: If you have installed the **<Globals name="igccli" />** prior to `v0.4.0`, you must uninstall it and follow the installation steps below. The uninstall command: `npm rm -g @garage-catalyst/ibm-garage-cloud-cli`
