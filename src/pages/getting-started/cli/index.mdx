...
**Warning**: If you have installed the **<Globals name="igccli" />** prior to `v0.4.0`, you must uninstall it and follow the installation steps below.

</InlineNotification>

To uninstall the old CLI:
```
...
View the CLI's help for the list of commands it provides.
>>>>>>> Install using Cloud Shell Commands
