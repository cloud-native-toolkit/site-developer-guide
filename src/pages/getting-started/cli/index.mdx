...
The Cloud Developer Tools includes the
...
<<<<<<< HEAD
- Register your application git repo into a **Jenkins** pipeline
...
=======
- List the dashboard URLs for the tools installed in the environment
...
>>>>>>> 7c9985ec9bfb37ebb612d2fcc06e6e7fd7970fb5
