...
Create a sample application and create a Jenkins pipeline to deploy it into your development cluster
...
lists the [Starter Kit Templates](/starterkits/overview).
...
- Change into the cloned directory
    ...
    cd stockbffnode
    ```
- You must rename the app to match your git repo or a that is unique for your solution.
