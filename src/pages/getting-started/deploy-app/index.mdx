...
Now create a pipeline for your repo. (See the CLI documentation for [igc pipeline
](/getting-started/cli#pipeline) for details about how the `pipeline` command works.)
