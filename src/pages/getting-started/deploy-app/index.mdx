...
Use a Starter Kit Template to create a sample app and create a Jenkins pipeline to deploy it into your development cluster
...
- Make sure you have installed all [Prerequisites](/admin/pre-reqs) listed before continuing
