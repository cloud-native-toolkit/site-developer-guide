...
**Note:** If you will be hosting the <Globals name="shortName" /> outside of <Globals name="ic" /> then you can jump
to [install the toolkit](install-toolkit/quick-install).
