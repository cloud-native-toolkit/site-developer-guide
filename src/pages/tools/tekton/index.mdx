...
- Read the this [Overview of Tekton](/tools/tekton#what-is-tekton)
...
- Install [IBM Garage for Cloud Developer Tools](/admin) on your
...
- Install Tekton pipelines and tasks into the `dev` namespace following the
 instructions in the repository [ibm-garage-tekton-tasks](https://github.com/cloud-native-toolkit/ibm-garage-tekton-tasks/blob/master/README.md)
- Install the `Tasks`
    ```bash
...
<AnchorLinks>
  ...
  <AnchorLink to="/getting-started-day-2/continuous-delivery">Continuous Delivery with ArgoCD</AnchorLink>
</AnchorLinks>
