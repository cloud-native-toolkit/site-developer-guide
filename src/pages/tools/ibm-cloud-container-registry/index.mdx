...
The CI and CD pipelines currently exchange two types of artifacts: Docker images and Helm charts. The CI pipeline ([Jenkins](/tools/jenkins), [Tekton](/tools/tekton/), etc.) builds these artifacts and ArgoCD deploys them. To store and share the artifacts, the pipeline uses two repositories:
- **Docker images**: This Developer Tools Image Registry
- **Helm charts**: A [Helm repository in Artifactory](/tools/artifact-management)
...
- If you haven't already, [deploy your first app](/getting-started-day-1/deploy-app)
