...
Once your key has been generated, the private key should be stored within a credentials vault, such as [Key Protect](../tools/key-protect) or [IBM HyperProtect Crypto Services](https://cloud.ibm.com/docs/hs-crypto?topic=hs-crypto-overview).
